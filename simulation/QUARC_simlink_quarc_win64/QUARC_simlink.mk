###########################################################################
## Makefile generated for component 'QUARC_simlink'. 
## 
## Makefile     : QUARC_simlink.mk
## Generated on : Wed Jul 03 15:50:41 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\QUARC_simlink.rt-win64
...
PRODUCT_NAME              = QUARC_simlink
MAKEFILE                  = QUARC_simlink.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2023a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2023a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\uos\Documents\pendulum_control\simulation
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = QUARC_simlink_comp.rsp
CMD_FILE                  = QUARC_simlink.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\QUARC_simlink.rt-win64
...
DEFINES_STANDARD = -DMODEL=QUARC_simlink -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\QUARC_simlink_quarc_win64\QUARC_simlink.c $(START_DIR)\QUARC_simlink_quarc_win64\QUARC_simlink_data.c $(START_DIR)\QUARC_simlink_quarc_win64\QUARC_simlink_main.c $(START_DIR)\QUARC_simlink_quarc_win64\rtGetInf.c $(START_DIR)\QUARC_simlink_quarc_win64\rtGetNaN.c $(START_DIR)\QUARC_simlink_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = QUARC_simlink.obj QUARC_simlink_data.obj QUARC_simlink_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\QUARC_simlink_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\QUARC_simlink_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
QUARC_simlink.obj : "$(START_DIR)\QUARC_simlink_quarc_win64\QUARC_simlink.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\QUARC_simlink_quarc_win64\QUARC_simlink.c"


QUARC_simlink_data.obj : "$(START_DIR)\QUARC_simlink_quarc_win64\QUARC_simlink_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\QUARC_simlink_quarc_win64\QUARC_simlink_data.c"


QUARC_simlink_main.obj : "$(START_DIR)\QUARC_simlink_quarc_win64\QUARC_simlink_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\QUARC_simlink_quarc_win64\QUARC_simlink_main.c"


rtGetInf.obj : "$(START_DIR)\QUARC_simlink_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\QUARC_simlink_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\QUARC_simlink_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\QUARC_simlink_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\QUARC_simlink_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\QUARC_simlink_quarc_win64\rt_nonfinite.c"

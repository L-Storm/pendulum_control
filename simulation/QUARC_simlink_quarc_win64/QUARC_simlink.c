...
void QUARC_simlink_output(void)
{
  ...
  c_idx_0 = QUARC_simlink_B.HILReadEncoder_o1;

  /* '<S1>:1:11' */
  if (QUARC_simlink_B.HILReadEncoder_o1 > 2.147483648E+9) {
    c_idx_0 = QUARC_simlink_B.HILReadEncoder_o1 - 4.294967296E+9;
  }
   ...
   */
  /* '<S1>:1:14' */
  QUARC_simlink_B.Add = c_idx_0 * 2.0 * 3.1415926535897931 / 4096.0 -
  ...
  c_idx_0 = QUARC_simlink_B.HILReadEncoder_o2;

  /* '<S2>:1:11' */
  if (QUARC_simlink_B.HILReadEncoder_o2 > 2.147483648E+9) {
    c_idx_0 = QUARC_simlink_B.HILReadEncoder_o2 - 4.294967296E+9;
  }

  /* '<S2>:1:14' */
  QUARC_simlink_B.otpt = c_idx_0 * 2.0 * 3.1415926535897931 / 4096.0;
  ...
  if (fabs(QUARC_simlink_B.Add) < 20.0) {
    ...
    /* '<S3>:1:41' */
    c_idx_0 = (QUARC_simlink_DW.previous_arm2_inpt - QUARC_simlink_B.Add) /
      0.002 * 0.0 + (QUARC_simlink_B.Add * 10.47 + 2.4532925 *
                     QUARC_simlink_DW.i2);

    /* '<S3>:1:42' */
    QUARC_simlink_B.otpt_v = c_idx_0;
...
void QUARC_simlink_update(void)
{
...

  {
     ...
     */
    if (!(++QUARC_simlink_M->Timing.clockTick1)) {
      ++QUARC_simlink_M->Timing.clockTickH1;
    }

    QUARC_simlink_M->Timing.t[1] = QUARC_simlink_M->Timing.clockTick1 *
      QUARC_simlink_M->Timing.stepSize1 + QUARC_simlink_M->Timing.clockTickH1 *
      QUARC_simlink_M->Timing.stepSize1 * 4294967296.0;
  }
}
...
RT_MODEL_QUARC_simlink_T *QUARC_simlink(void)
{
  ...
  {
    /* Setup solver object */
    rtsiSetSimTimeStepPtr(&QUARC_simlink_M->solverInfo,
                          &QUARC_simlink_M->Timing.simTimeStep);
    rtsiSetTPtr(&QUARC_simlink_M->solverInfo, &rtmGetTPtr(QUARC_simlink_M));
    rtsiSetStepSizePtr(&QUARC_simlink_M->solverInfo,
                       &QUARC_simlink_M->Timing.stepSize0);
    rtsiSetErrorStatusPtr(&QUARC_simlink_M->solverInfo, (&rtmGetErrorStatus
      (QUARC_simlink_M)));
    rtsiSetRTModelPtr(&QUARC_simlink_M->solverInfo, QUARC_simlink_M);
  }

  rtsiSetSimTimeStep(&QUARC_simlink_M->solverInfo, MAJOR_TIME_STEP);
  rtsiSetSolverName(&QUARC_simlink_M->solverInfo,"FixedStepDiscrete");
  ...
  /* Initialize timing info */
  {
    ...
    /* task periods */
    QUARC_simlink_M->Timing.sampleTimes[0] = (0.0);
    QUARC_simlink_M->Timing.sampleTimes[1] = (0.002);

    /* task offsets */
    QUARC_simlink_M->Timing.offsetTimes[0] = (0.0);
    QUARC_simlink_M->Timing.offsetTimes[1] = (0.0);
  }
  ...
  /* External mode info */
  QUARC_simlink_M->Sizes.checksums[0] = (3075812218U);
  QUARC_simlink_M->Sizes.checksums[1] = (66269794U);
  QUARC_simlink_M->Sizes.checksums[2] = (1406776122U);
  QUARC_simlink_M->Sizes.checksums[3] = (2596256496U);
